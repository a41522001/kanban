export const en = {
  ...
  notification: {
    ...
    emptyDescription: 'New invitations and project activity will appear here.',
    ...
    workspaceInvited: {
      ...
      detail: {
        close: 'Close invitation details',
        loadingTitle: 'Workspace invitation',
        loadingDescription: 'Loading invitation',
        pendingTitle: 'Workspace invitation',
        pendingDescription: 'Waiting for your response',
        acceptedTitle: 'Invitation accepted',
        acceptedDescription: 'Workspace joined',
        declinedTitle: 'Invitation declined',
        declinedDescription: 'Response complete',
        unavailableTitle: 'This invitation is no longer available',
        unavailableDescription: 'The invitation may have expired or been canceled.',
        invitedBy: '{inviter} invited you to join',
        memberRole: 'Member',
        expiresIn: 'Invitation expires {date}',
        pendingBody: 'Join to view workspace projects and collaborate as a member.',
        acceptedBody: 'The workspace is now in your workspace list.',
        declinedBody: 'This invitation no longer accepts responses.',
        unavailableBody:
          'This invitation may have expired or been canceled. No response is available.',
        loadingBody: 'Loading invitation details',
        accept: 'Accept invitation',
        decline: 'Decline',
        accepting: 'Accepting',
        declining: 'Declining',
        ...
        retry: 'Reload',
        loadError: 'Unable to load invitation details. Please try again.',
      },
    },
    projectMemberAdded: {
      summaryTitle: 'You joined a project',
      summaryBody: 'Open the notification to see the project, workspace, and your role.',
      openDetails: 'Open project membership notification details',
      detail: {
        title: 'You joined a project',
        description: 'The project is in your workspace and ready for collaboration',
        mobileDescription: 'You can start collaborating now',
        close: 'Close project membership notification details',
        loading: 'Loading project membership details',
        addedBy: '{inviter} added you',
        joined: 'Joined',
        memberInfo: 'Membership details',
        workspace: 'Workspace',
        role: 'Project role',
        joinedAt: 'Joined at',
        unknownJoinedAt: 'Unknown time',
        dismiss: 'Close',
        openProject: 'Open project',
        availability: 'You can reopen this project from “{workspace}” at any time',
        errorTitle: 'Unable to load project details',
        errorDescription:
          'The project may be archived or no longer available to you. Reload and try again.',
        retry: 'Reload',
      },
    },
  },
  workspace: {
    ...
    projectDialog: {
      ...
      description: 'Create a project in “{workspace}”, then open its Board when you are ready.',
      nameLabel: 'Project name',
      namePlaceholder: 'For example: Website redesign',
      descriptionLabel: 'Project description (optional)',
      descriptionPlaceholder: 'Briefly describe the goal or scope',
    },
    projectValidation: {
      nameRequired: 'Enter a project name',
      nameMaxLength: 'Project name must be 100 characters or fewer',
    },
    projectMembers: {
      addTitle: 'Add project member',
      addDescription: 'Choose a member from “{workspace}” to add to this project.',
      close: 'Close add project member dialog',
      currentCount: '{count} current project members',
      workspaceMembers: 'Workspace members',
      searchPlaceholder: 'Search workspace members',
      availableMembers: 'Available members',
      workspaceMember: 'Workspace member',
      joined: 'Joined',
      joinedWithRole: 'Already a project member · {role}',
      projectRole: 'Project role',
      loading: 'Loading workspace members…',
      emptyTitle: 'No matching members',
      emptyDescription: 'Try another search or confirm that this person joined the workspace.',
      loadErrorTitle: 'Unable to load members',
      loadErrorDescription: 'Check your connection and try again.',
      addAction: 'Add member',
      adding: 'Adding…',
      addSuccess: 'Project member added',
      addError: 'Unable to add this project member. Please try again.',
      roles: {
        OWNER: { label: 'Owner', description: 'Manages the project and members' },
        EDITOR: { label: 'Editor', description: 'Can edit the board' },
    ...
    states: {
      ...
      noProjectsDescription: 'Create your first project to organize work and open its Board.',
      noMatchingProjectsTitle: 'No matching projects',
      noMatchingProjectsDescription: 'Try changing the search text or status filter.',
      projectLoadErrorTitle: 'Unable to load projects',
      projectLoadErrorDescription: 'The workspace is still available. Reload the project list.',
    },
  },
  auth: {
    sidebar: {
